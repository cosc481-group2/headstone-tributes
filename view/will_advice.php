    ...
    <div class="accordion" id="accordionPanelsStayOpen">
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                <div class="accordion-body">
                    <strong>If you die without a valid will, you'll become what's called intestate. </strong>That usually means your estate will be settled based on the laws of your state that outline who inherits what. Probate is the legal process of transferring the property of a deceased person to the rightful heirs.
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                <div class="accordion-body">
                    <strong>Estate planners almost universally advise against joint wills, and some states don't even recognize them. </strong>Odds are you and your spouse won't die at the same time, and there's probably property that's not jointly held. That's why separate wills make better sense, even though your will and your spouse's will might end up looking remarkably similar.
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingFive">
                <div class="accordion-body">
                    <strong>You can name your spouse, an adult child, or another trusted friend or relative as your executor. </strong>If your affairs are complicated, it might make more sense to name an attorney or someone with legal and financial expertise. You can also name joint executors, such as your spouse or partner and your attorney.
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingSix">
                <div class="accordion-body">
                    <strong>If you wish to leave certain personal property to certain heirs, indicate as much in your will. </strong>In addition, you can create a separate document called a letter of instruction that you should keep with your will.
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseEight" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingEight">
                <div class="accordion-body">
                    <strong>It's possible that your will may never need to be updated — or you may choose to update it regularly. </strong>The decision is yours. Remember, the only version of your will that matters is the most current valid one in existence at the time of your death.
